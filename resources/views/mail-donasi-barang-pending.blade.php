                                 ...
                                 <td>
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: 'Open Sans', sans-serif; font-size: 14px; color: #3E3E3E; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                Silahkan kirim barang yang di donasikan di alamat dibawah ini:
                                             </td>
                                          </tr>
                                          <!-- End of content -->
                                          <!-- spacing -->
                                          ...
                                          <!-- bank -->
                                             ...
                                             <td style="font-family: 'Open Sans', sans-serif; line-height: 30px; background-color: #f3f3f3; text-align: center;" st-content="fulltext-content">
                                                <h2 style="font-size: 14px; color: #3E3E3E; line-height: 20px; font-weight: bold">Palang Merah Indonesia (PMI) Provinsi DKI Jakarta</h2>
                                             </td>
                                          </tr>
                                          <tr>
                                             <td style="font-family: 'Open Sans', sans-serif; line-height: 30px; background-color: #f3f3f3; text-align: center;" st-content="fulltext-content">
                                                <label style="font-size: 9px; color: #3E3E3E;">Alamat Lengkap:</label>
                                                <p style="font-size: 14px; color: #3E3E3E; line-height: 20px; padding-bottom: 15px;">Jl. Kramat Raya No. 47 Jakarta Pusat 10450</p>
                                             </td>
                                          </tr>
                                          <!-- End of bank -->
                                          <!-- spacing -->
