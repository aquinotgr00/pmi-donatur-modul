                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <a target="_blank" href="#"><img width="113" border="0" height="132" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="img/reject.png" class="banner"></a>
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: 'Open Sans', sans-serif; font-size: 14px; color: #3E3E3E; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                Donasi kamu dengan berat hati kami batalkan karena sudah melebihi batas waktu transfer.
                                             </td>
                                          </tr>
                                          <!-- End of content -->
                                          <!-- spacing -->
                                          ...
                                          <tr>
                                             <td style="font-family: 'Open Sans', sans-serif; font-size: 14px; color: #3E3E3E; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                Tapi jangan khawatir, kamu bisa berdonasi kembali kapan saja.
                                                <br>Terima kasih.
                                             </td>
                                          </tr>
                                          <!-- End of content -->
